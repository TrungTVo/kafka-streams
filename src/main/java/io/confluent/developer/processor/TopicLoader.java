        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            try {
                ...
                ElectronicOrder electronicOrderOne = ElectronicOrder.newBuilder()
                        .setElectronicId("HDTV")
                        .setOrderId("instore-1")
                        .setUserId("10261998")
                        .setPrice(2000.00)
                        .setTime(instant.toEpochMilli()).build();

                instant = instant.plus(35L, ChronoUnit.SECONDS);
                ...
                ElectronicOrder electronicOrderFive = ElectronicOrder.newBuilder()
                        .setElectronicId("HDTV")
                        .setOrderId("instore-1")
                        .setUserId("1037894844")
                        .setPrice(5000.98)
                        .setTime(instant.toEpochMilli()).build();


                var electronicOrders = List.of(
                    electronicOrderOne,
                    electronicOrderTwo,
                ...
                electronicOrders.forEach((electronicOrder -> {
                    ...
                    try {
                        Thread.sleep(35000);    // Sleep 10 seconds between producing each record
