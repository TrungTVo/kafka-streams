...
public class StreamsJoin {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SpecificAvroSerde<ApplianceOrder> applianceSerde = StreamsUtils.getSpecificAvroSerde(configMap);
        SpecificAvroSerde<ElectronicOrder> electronicSerde = StreamsUtils.getSpecificAvroSerde(configMap);
        SpecificAvroSerde<CombinedOrder> combinedSerde = StreamsUtils.getSpecificAvroSerde(configMap);
        SpecificAvroSerde<User> userSerde = StreamsUtils.getSpecificAvroSerde(configMap);
        ...
        try (KafkaStreams kafkaStreams = new KafkaStreams(builder.build(), streamsProps)) {
            ...
            // TopicLoader.runProducer();           // skip if already run joins_topic_loader
            try {
                kafkaStreams.start();
                shutdownLatch.await();
            } catch (Throwable e) {
